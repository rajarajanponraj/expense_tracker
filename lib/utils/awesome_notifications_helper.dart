    ...
    await awesomeNotifications.initialize(
        ...
        [
          ...
          NotificationChannel(
              ...
              playSound: true,
              importance: NotificationImportance.Max),
          NotificationChannel(channelKey: NotificationChannels.scheduleChannelKey, channelName: NotificationChannels.scheduleChannelName, channelDescription:NotificationChannels.scheduleChannelDescription )
        ], channelGroups: [
...
//schedule notification
  static String get scheduleChannelKey => "scheduled_notification";
  static String get scheduleChannelName => "scheduled Notification";
